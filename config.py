...
OPENROUTER_MODEL = get_env_var("OPENROUTER_MODEL", DEFAULT_MODEL)

# Defaults
DEFAULT_LIMIT = 100
DEFAULT_BATCH_SIZE_FILTER = 5
...
DEFAULT_MAX_TOKENS_RELEVANCE = 1000
DEFAULT_MAX_TOKENS_ANALYSIS = 2000
DEFAULT_MAX_TOKENS_THEME_SUMMARY = 1500
